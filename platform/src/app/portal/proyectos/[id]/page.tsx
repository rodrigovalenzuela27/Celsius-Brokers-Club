...
/** Ficha pública del proyecto con visualizador (anon, RLS pública). */
export default async function PublicProjectDetail({
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      <Link href="/portal/proyectos" className="section-mark hover:text-accent">
        ← Proyectos
      </Link>
      ...
      <p className="section-mark mb-3">
        § Elige tu unidad · disponibilidad en vivo
      </p>
      <BuildingVisualizer
        projectId={project.id}
        initialUnits={units ?? []}
        quotePathPrefix="/portal/cotizar?unit="
      />
